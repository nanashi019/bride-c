    ...
    <div class="contact-2">
      ...
      <div class="buttons">
        <div class="contact-2-call">
          <a href="tel:010-8357-1890"><img :src="require('@/assets/images/phone.svg')" /></a>
        </div>
        <div class="contact-2-msg">
          <a href="sms:010-8357-1890"><img :src="require('@/assets/images/envelope.svg')" /></a>
        </div>
      </div>
    </div>
    <!-- 신부에게 연락하기 -->
